...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 w-full flex flex-col items-center justify-center">
      <div className="min-h-screen max-w-8xl px-4 sm:px-6 lg:px-8 xl:pr-16 grid md:grid-cols-5 gap-4">
        <div className="md:col-span-2 flex flex-col items-center justify-center w-full py-12">
        ...
        <div className="animate-fade-in md:col-span-3 flex flex-col items-stretch justify-start w-full">
          {result ? (
          <div className='flex flex-col items-center justify-start md:max-h-screen overflow-y-auto overflow-x-hidden py-10 scrollbar-hide'>
            <div className="space-y-3">
              ...
              <div className="w-full bg-white/70 rounded-lg border border-gray-100 overflow-hidden">
                <div className="flex items-center gap-2 px-5 py-3 border-b border-gray-100">
                  <AiFillYoutube className="text-red-600 w-24 h-24" />
                ...
                <div className="relative w-full aspect-video">
                  <iframe
                    ...
                    src={`https://www.youtube.com/embed/${result.video_metadata.video_id}`}
                ...
                <div className="px-5 py-4 grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-800">{result.video_metadata.author}</p>
                  </div>
                  <div>
                    <p className="text-gray-500 font-medium">Views</p>
                    <p className="text-gray-800">
                      {Number(result.video_metadata.view_count).toLocaleString()}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-500 font-medium">Video Length</p>
                    <p className="text-gray-800">
                      {Math.floor(Number(result.video_metadata.length_seconds) / 60)} mins
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-500 font-medium">Video URL</p>
                    <a className="text-blue-500" href={`https://www.youtube.com/watch?v=${result.video_metadata.video_id}`}>
                      {`https://www.youtube.com/watch?v=${result.video_metadata.video_id}`}
                    </a>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4 w-full">
                <div className="flex flex-col items-center gap-3 bg-indigo-50 rounded-lg px-4 py-2">
                  <span className="text-indigo-600 font-medium">Total Comments</span>
                ...
                <div className="flex flex-col items-center gap-3 bg-blue-50 rounded-lg px-4 py-2">
                  <span className="text-blue-600 font-medium">Positive Score</span>
              ...
              <div className="bg-purple-50 rounded-lg px-4 py-2">
                <span className="text-purple-600 font-bold">Summary</span>
                <p className="text-gray-800 mt-1">{result.summary}</p>
              </div>
              <div className="bg-green-50 rounded-lg px-4 py-2">
                <span className="text-green-600 font-bold">Suggestions</span>
          ...
          <div className='flex flex-col items-center justify-center h-full'>
            <div className="text-center space-y-6 px-10 m-3 animate-fade-in">
      ...
      <style jsx global>{`
        ...
        @keyframes border-glow { 0%, 100% { box-shadow: 0 0 24px 4px #6366f1, 0 0 0 0 #3b82f6; } 50% { box-shadow: 0 0 32px 8px #3b82f6, 0 0 0 0 #6366f1; } }
